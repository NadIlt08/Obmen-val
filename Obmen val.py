...
b_combobox = ttk.Combobox(values=list(cur.keys())) # из словаря делаем список
...
t_combobox = ttk.Combobox(values=list(cur.keys())) # из словаря делаем список
